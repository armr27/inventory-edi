        ...
        <ul class="navbar-nav bg-gradient-secondary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?= base_url() ?>home">
                <div class="sidebar-brand-text">
                    <img src="<?= base_url(); ?>assets/icon/R.png" width="150px">
                </div>
            ...
            <?php if ($title == 'Dashboard') : ?>
                ...
                <?php if ($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'member') : ?>
                    ...
                    <?php if ($this->session->userdata('login_session')['level'] == 'admin' || $this->session->userdata('login_session')['level'] == 'member' || $this->session->userdata('login_session')['level'] == 'kepala gudang') : ?>
